...
func buildRoomFindBaseRequest(runtime *common.RuntimeContext) (*roomFindRequest, error) {
	req := &roomFindRequest{
		...
		Query:       strings.TrimSpace(runtime.Str(flagQuery)),
...
func callRoomFind(runtime *common.RuntimeContext, req *roomFindRequest) ([]*roomFindSuggestion, error) {
	...
	if err != nil {
		return nil, output.ErrWithHint(output.ExitInternal, "request_fail", "api request fail", err.Error())
	}
...
var CalendarRoomFind = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: flagFloor, Type: "string", Desc: "meeting room floor constraint (recommended canonical form such as F2)"},
		{Name: flagRoomName, Type: "string", Desc: "meeting room name constraint"},
		{Name: flagQuery, Type: "string", Desc: "meeting room weak-recall keywords for supplemental search only"},
	...
	Validate: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		for _, flag := range []string{flagCity, flagBuilding, flagFloor, flagRoomName, flagQuery, flagEventRrule, flagTimezone} {
